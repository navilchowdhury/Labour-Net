        ...
        <div className="professional-card-body">
          ...
          >
            <div className="professional-form-group">
              <label className="professional-form-label">📍 Location/Address</label>
              <input
                type="text"
            ...
            <div className="professional-form-group">
              <label className="professional-form-label">🛠️ Job Category</label>
              <select
                className="professional-form-input"
            ...
            <div className="professional-form-group">
              <label className="professional-form-label">⏰ Availability</label>
              <select
                className="professional-form-input"
            ...
            <div className="professional-form-group">
              <label className="professional-form-label">✅ Verification Status</label>
              <div
                style={{
                  display: 'flex',
                  alignItems: 'center',
